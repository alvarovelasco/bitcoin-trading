...
import org.sonar.challenge.book.subscription.difford.CreateDiffOrderForBookUpdateCommandContext;
import org.sonar.challenge.book.subscription.difford.DiffOrderMergeIntoOrderBookCommandExecutor;
import org.sonar.challenge.book.subscription.difford.DiffOrderOnBookSubscribeFeederImpl;
import org.sonar.challenge.book.subscription.difford.OrderBookRESTProvideToContextCommandExecutor;
import org.sonar.challenge.book.subscription.difford.SubscribeDiffOrderCommandExecutor;
...
public class DiffOrderOnBookSubscribeFeederImplTest {
	...
	public void test_StopFeeder_whenSuccess() throws BitsoSubscribeException {
		SubscribeFeeder<UpdatedOrderBook> diffOrderOnBook = 
				new DiffOrderOnBookSubscribeFeederImpl("whatever", context, subscribeDiffOrderCommandExecutor, 
									orderBookRESTProvideToContextCommandExecutor, mergeIntoOrderBookCommandExecutor);
	...
	private void test_successFeedingStartSerie(int updatesOnSubscriptionUpdater) throws SonarChallengeException {
		SubscriptionUpdater<UpdatedOrderBook> subscriptionUpdater = mock(SubscriptionUpdater.class);
		SubscribeFeeder<UpdatedOrderBook> diffOrderOnBook = 
				new DiffOrderOnBookSubscribeFeederImpl("whatever", context, subscribeDiffOrderCommandExecutor, 
									orderBookRESTProvideToContextCommandExecutor, mergeIntoOrderBookCommandExecutor);
		...
		verify(subscriptionUpdater, VerificationModeFactory.times(updatesOnSubscriptionUpdater)).onUpdate(any(UpdatedOrderBook.class));
	}
